...
- Bu politika, Bilim Haritası Kurumu / Hazzed tarafından yönetilen bilgi varlıklarının gizliliğini, bütünlüğünü ve erişilebilirliğini korumak amacıyla uygulanacak temel güvenlik ilkelerini ve önlemlerini açıklar.

Kapsam

- Politika tüm çalışanlar, yükleniciler, hizmet sağlayıcılar ve bilgi sistemleri için geçerlidir.
...
- Tedarikçi güvenliği değerlendirilmeli ve gerektiğinde sözleşmeye özel güvenlik şartları eklenmelidir.

Eğitim ve Farkındalık

- Tüm ilgili personel periyodik güvenlik eğitimi alır.

Denetim ve Sürekli İyileştirme

- Politika yıl içinde periyodik olarak gözden geçirilir ve güncellenir.

İletişim

- Güvenlikle ilgili bildirim ve sorular için: [bilimharitasi@hotmail.com](mailto:bilimharitasi@hotmail.com)
